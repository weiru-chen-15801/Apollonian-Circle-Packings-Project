...
public class ElectrostaticEnergy {
	public static double value(Point2D.Double a, Point2D.Double b) {
    ...
    public static double getSigma(int newM) {
		...
		int numberOfPoints = Tree.numOfCircles(tCircle1) + Tree.numOfCircles(tCircle2)
        + Tree.numOfCircles(tCircle3) + Tree.numOfCircles(tCircle4);
        ...
        double e_M = delta / (double) (Math.pow(M, 2*ro));
        System.out.println("The ratio is " + e_M);
...
public static double getSigma2(int newM) {
...
public static double getSigma3(int newM) {
	
	//first: 2.0944
	//second: 1.5712
	//third: 4.0123
	
	double theta1 = 4.0123;
	double theta2 = 5.0126;
	double ro = 1.305688;
